document.addEventListener("DOMContentLoaded", function() {
  ...
  // Validate user input in the first table
  round1TableBody.addEventListener("input", function(event) {
    ...
    const allInputsFilled = Array.from(round1TableBody.querySelectorAll("input")).every(function(input) {
